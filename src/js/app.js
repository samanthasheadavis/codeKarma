(function($) {
  ...
  codeKarmaApp.config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('codeKarmaParent', {
      ...
      }).state('codeKarmaParent.clientEditProjects', {
          url: 'client/edit-projects',
          controller: 'ClientEditProjectsController as clientEditProjects',
          templateUrl: 'src/templates/client-edit-projects.html'
